...
describe('Rocket Clone Utility:', () => {
   ...
   it('Should clone an object and apply a class.', () => {
      ...
      const testTrooper = new StarWarsTrooper({name: 'Clone Trooper', originalTrilogy: false});
      let testTrooperClone = RocketClone({data: testTrooper, applyClass: StarWarsTrooper});
