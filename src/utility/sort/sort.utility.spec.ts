...
describe('Rocket Sort Utility:', () => {
   ...
   it('Should naturally sort an array in the desired direction.', () => {
      ...
      expect(RocketSort.array({data: testArray}))
         .toEqual(resultAsc);

      expect(RocketSort.array({data: testArray, order: SortOrder.ASCENDING}))
         .toEqual(resultAsc);

      expect(RocketSort.array({data: testArray, order: SortOrder.DESCENDING}))
         .toEqual(resultDesc);
   });
   ...
   it('Should naturally sort an array of objects by a common field in the desired direction.', () => {
      ...
      expect(RocketSort.array({data: testArray, by: 'name'}))
         .toEqual(resultAsc);

      expect(RocketSort.array({data: testArray, by: 'name', order: SortOrder.ASCENDING}))
         .toEqual(resultAsc);

      expect(RocketSort.array({data: testArray, by: 'name', order: SortOrder.DESCENDING}))
         .toEqual(resultDesc);
   });
   ...
   it('Should naturally sort a map in the desired direction.', () => {
      ...
      expect(RocketSort.map({data: testMap}))
         .toEqual(resultAsc);

      expect(RocketSort.map({data: testMap, order: SortOrder.ASCENDING}))
         .toEqual(resultAsc);

      expect(RocketSort.map({data: testMap, order: SortOrder.DESCENDING}))
         .toEqual(resultDesc);
   });
   ...
   it('Should naturally sort a map of objects by a common field in the desired direction.', () => {
      ...
      expect(RocketSort.map({data: testMap, by: 'name'}))
         .toEqual(resultAsc);

      expect(RocketSort.map({data: testMap, by: 'name', order: SortOrder.ASCENDING}))
         .toEqual(resultAsc);

      expect(RocketSort.map({data: testMap, by: 'name', order: SortOrder.DESCENDING}))
         .toEqual(resultDesc);
   });
});
